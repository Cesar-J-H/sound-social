        ...
        <div ref={searchRef} className="flex-1 max-w-md relative">
          ...
          {showResults && hasResults && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-zinc-200 rounded-2xl shadow-xl overflow-hidden z-50">
              ...
              {results.albums.length > 0 && (
                <div>
                  <div className="px-4 py-2 text-2xs font-semibold text-zinc-400 uppercase tracking-widest bg-zinc-50 border-b border-zinc-100 border-t border-t-zinc-100">
                    Albums
                  </div>
              ...
              <div className="border-t border-zinc-100">
                <button
                  ...
                  className="w-full px-4 py-3 text-sm text-orange-500 font-medium hover:bg-orange-50 transition-colors text-left"
                >
